...
Purpose:
Use semaphores to synchronize producers and consumers.
Each producer generates random numbers and places them in a shared queue.
Consumers remove numbers, check for primes, and write primes to a file.
"""
